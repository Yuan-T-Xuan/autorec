...
def PMLP(batch_size, dim_user_embed, dim_item_embed, total_users, total_items, mlp_dims, l2_reg=None,
    ...
    def interaction_graph(subgraph):
        PointwiseMLPCE(dims=mlp_dims,
                     user=subgraph['user_vec'], 
                     item=subgraph['item_vec'],
                     item_bias=subgraph['item_bias'], 
                     labels=subgraph['label'],
                     l2_reg=l2_reg,
                     train=True, subgraph=subgraph, scope='PointwiseMLPCE')
    ...
    def serve_interaction_graph(subgraph):
        PointwiseMLPCE(dims=mlp_dims,
                     ...
                     item_bias=subgraph['item_bias'],
                     l2_reg=l2_reg,
                     train=False, subgraph=subgraph, scope='PointwiseMLPCE')
