...
def PED(batch_size, dim_embed, total_users, total_items, l2_reg=None, eu_dist_margin=1.0,
    ...
    def interaction_graph(subgraph):
        PairwiseEuDist(subgraph=subgraph,
            user_vec=subgraph['user_vec'],
            ...
            margin=eu_dist_margin,
            train=True, scope='PairwiseEuDist')
    ...
    def serve_interaction_graph(subgraph):
        PairwiseEuDist(subgraph=subgraph,
            ...
            margin=eu_dist_margin,
            train=False, scope='PairwiseEuDist')
